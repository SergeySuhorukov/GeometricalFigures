...
INC_PATH = $${PROJECT_ROOT_PATH}/unclude/
...
INCLUDEPATH += $${PROJECT_ROOT_PATH}/src/headers/geometryFactory/
INCLUDEPATH += $${PROJECT_ROOT_PATH}/src/headers/ui/
INCLUDEPATH += $${PROJECT_ROOT_PATH}/src/headers/other/
